...
\multirow{4}{*}{\rotatebox{90}{TWR}} & \textbf{FT}  & \textbf{119.9}   & \textbf{Tower}           \\% \cline{2-4}
                     & WT           & 124.850          & West Tower               \\ %\cline{2-4}
                     & NT           & 136.5            & North Tower              \\ %\cline{2-4}
                     & CT           & 118.775          & Center Tower             \\ \hline
\multirow{6}{*}{\rotatebox{90}{APP}} & \textbf{FN}  & \textbf{120.8}   & \textbf{North Arrival}   \\ %\cline{2-4}
                     & FS           & 125.350          & South Arrival            \\ %\cline{2-4}
                     & FF           & 127.275          & North Director           \\ %\cline{2-4}
                     & \textbf{FU}  & \textbf{118.5}   & \textbf{South Director}  \\ %\cline{2-4}
