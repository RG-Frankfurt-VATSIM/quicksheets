...
\begin{textblock}{30}(0,13)

\begin{table}[]
\begin{tabular}{|c|l|c|c|c|l}
\multicolumn{5}{c}{\textbf{North Standard 07/25}}  \\ \cline{1-5}
...
\begin{textblock}{2}(110,13)
\begin{table}[]
\begin{tabular}{|c|l|c|c|c|c|c|c|l}
\multicolumn{8}{c}{\textbf{South Standard 18}}                                                                                                                                                                                                                  &                                  \\ \cline{1-8}
...
\multirow{2}{*}{\textbf{18}} & If able          & \textbf{1L} (1U)                            & \textbf{1L}                                 & \textbf{9L} (2A)         & \textbf{1S}              & \textbf{}                          & \textbf{9S \textcolor{purple}{*}}             &                                  \\ \cline{2-8}
                             & If unable        & ULKIG1L                                     & 1L                                          &                          & 1L                       &                                    & 9L                       &                                  \\ \cline{1-8}
...
\multirow{2}{*}{}    & \textbf{ADF} & \textbf{118.025} & \textbf{ATIS}            \\ %\cline{2-4}
                     & \textbf{FC}  & \textbf{121.9}   & \textbf{Delivery}        \\ \hline
...
\multirow{4}{*}{\rotatebox{90}{TWR}} & \textbf{FT}  & \textbf{119.900} & \textbf{Tower}           \\% \cline{2-4}
                     ...
                     & NT           & 136.5            & North Tower              \\ %\cline{2-4}
...
\multirow{7}{*}{\rotatebox{90}{CTR}} & GC              & 135.725          & Complete                 \\ %\cline{2-4}
                     ...
                     & \textbf{UW}  & \textbf{133.650} & \textbf{Rhein West}      \\
                     & UT           & 132.4            & Rhein TGO                \\ %\cline{2-4}
                     & UN           & 132.775          & Rhein NTM                \\ %\cline{2-4}
                     & UF           & 136.325          & Rhein Fulda              \\ \hline
\end{tabular}
\end{table}
\end{textblock}
